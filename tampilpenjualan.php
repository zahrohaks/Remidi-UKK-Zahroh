        ...
        <div class="table-wrapper">
            ...
            <form action="" method="post">
              ...
              <select name="pilih">
                ...
                <option value="tgl_penjualan">Tanggal Penjualan</option>
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['total_harga']; ?></td>
                    ...
                    <td>
                    <a href="editpenjualan.php?id_penjualan=<?php echo $row['id_penjualan']?>">Edit</a> |
                    <a href="hapuspenjualan.php?id_penjualan=<?php echo $row['id_penjualan']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
            ...
            <a href="tampildetailpenjualan.php" class="kembali" title="Kembali" data-toggle="tooltip">Kembali</a>
    </div>  
</div>   
</body>
</html>