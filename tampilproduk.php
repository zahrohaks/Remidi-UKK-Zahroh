...
<div class="container-xl">
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <p><a href="tambahproduk.php" class="tambah" title="Tambah" data-toggle="tooltip">+ Tambah Data</a></p>
...
foreach ($tampil as $row) {
 ...
 <td><?php echo $row['stok']; ?></td>
                    ...
                    <td>
                    <a href="editproduk.php?id_produk=<?php echo $row['id_produk']?>">Edit</a> |
                    <a href="hapusproduk.php?id_produk=<?php echo $row['id_produk']?>">Delete</a>
 </td>
                    </tr>
                <?php
                }
